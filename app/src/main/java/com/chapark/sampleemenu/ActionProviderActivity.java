package com.chapark.sampleemenu;
...
public class ActionProviderActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == Activity.RESULT_OK){
            ...
            Intent shareInetent = new Intent(Intent.ACTION_SEND);
            shareInetent.setDataAndType(uri, "imagme/jpeg");
            shareInetent.putExtra(Intent.EXTRA_SUBJECT,"subject");
            mProvider.setShareIntent(shareInetent);
        }
    }
